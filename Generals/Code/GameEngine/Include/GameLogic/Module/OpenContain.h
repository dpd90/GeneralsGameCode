...
public:
	...
	virtual void friend_getVisibleRiders( std::vector<const Object*>& riders ) const override { const Object* r = friend_getRider(); if( r ) riders.push_back( r ); } ///< Default: same single rider friend_getRider() returns.
